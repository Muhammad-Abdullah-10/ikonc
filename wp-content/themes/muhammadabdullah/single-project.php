    ...
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        <article class="row" id="post-<?php the_ID(); ?>" <?php post_class('single-project'); ?>>
            ...
            <div class="entry-content single-pro-wrap">
                ...
                <div class="single-arch-acfs row">
                    <div class="col-md-3 col-12">
                        <h6>Project Start Date : <span>
                            <?php echo esc_html( get_field("project_start_date")); ?>
                        </span>
                        </h6>
                    </div>
                    <div class="col-md-3 col-12">
                        <h6>Project End Date : <span>
                            <?php echo esc_html(  get_field("project_end_date")); ?>
                        </span>
                        </h6>
                    </div>
                    <div class="col-md-3 col-12">
                        <h6>
                           <a href=" <?php echo esc_url( get_field("project_url")); ?>"> Project Link</a> 
                        </h6>
                    </div>
                </div>
